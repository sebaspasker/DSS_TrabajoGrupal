			...
			<div class="row m-0">
				...
				<div class="col-12 p-0">
					<div class="w-100 bg-light" style="height: 130px; position: relative;">
						...
						<input  type="file" required name="imagen" accept="image/*" class="clearablefileinput" id="id_imagen">
					</div>
				</div>
				<!-- name -->
				<div class="col-12 p-0">
                    <input type="text" name="source" class="form-control mt-3" placeholder="Nombre de la categoria">
				</div>
				<!-- footer -->
